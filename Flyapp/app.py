...
class VehicleListing(Base):
    ...
    URL = Column(String)
    Rebuilt_Predicted = Column(Boolean)

# Create the engine and session
engine = create_engine('postgresql://vtuomrvo:HiddevHxX0ael2UUEJ3_SHODrqGNxRgi@batyr.db.elephantsql.com/vtuomrvo')
...
def get_all_vehicles():
    ...
    for entry in all_entries:
        vehicle = {
            ...
            'URL': entry.URL,
            'Rebuilt_Predicted': entry.Rebuilt_Predicted
        }
